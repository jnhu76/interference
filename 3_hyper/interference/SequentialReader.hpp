...
public:
   SequentialReader(const string &nvm_file, ub8 byte_count, bool is_ram, ub4 tid, string config, bool is_Arachne)
           : Worker(tid, config, is_Arachne)
   ...
   static void * Run_helper(void * context) {
      return ((SequentialReader *) context) -> Run();
   }
